...
int csv_get_field(char *dest, size_t dest_len, CSV_BUFFER *source, size_t row, size_t entry);
int csv_get_field_length(CSV_BUFFER *buffer, size_t row, size_t entry);

int csv_copy_row(CSV_BUFFER *dest, int dest_row, CSV_BUFFER *source, int source_row);
int csv_clear_row(CSV_BUFFER *buffer, size_t row);
int csv_remove_row(CSV_BUFFER *buffer, size_t row);

int csv_copy_field(CSV_BUFFER *dest, int dest_row, int dest_entry, CSV_BUFFER *source, int source_row, int source_entry);
